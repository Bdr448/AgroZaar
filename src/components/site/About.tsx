      ...
      <div className="container-x grid items-center gap-14 lg:grid-cols-2">
        <div className="relative order-2 lg:order-1">
          <div className="overflow-hidden rounded-3xl border border-border shadow-card">
            <img src={founder.url} alt="Sharad Patel, Founder & CEO of Agrozaar Foods LLP" width={800} height={800} loading="lazy" className="aspect-[4/5] w-full object-cover" />
          </div>
        ...
        <div className="order-1 lg:order-2">
          <span className="text-sm font-semibold uppercase tracking-[0.18em] text-primary">About the Company</span>
          ...
          <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
            Agrozaar Foods LLP is a spice manufacturing and export company committed to delivering high-quality, pure and authentic spices under its flagship brand <span className="font-semibold text-foreground">Aviraaj</span>. We bring the true taste of Indian spices to every kitchen — domestic and international.
          </p>
          ...
          <div className="mt-9 grid grid-cols-3 gap-4">
            {[["2026", "Founded"], ["100%", "Pure & Natural"], ["Global", "Export Ready"]].map(([n, l]) => (
