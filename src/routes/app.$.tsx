...
function InvoicesModule() {
  return (
    <Stub
      title="Invoices"
      subtitle="Manage customer billing invoices and receipts"
      icon={Receipt}
    />
  );
}
...
function PaymentsModule() {
  return (
    <Stub
      title="Payments"
      subtitle="Track incoming and outgoing payment transactions"
      icon={Wallet}
    />
  );
}
...
function ExpensesModule() {
  return (
    <Stub
      title="Expenses"
      subtitle="Log and categorise business operating expenses"
      icon={FileText}
    />
  );
}
